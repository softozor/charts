    ...
    steps {
        script {
            ...
            scriptContent = """
                ...
                curl -is -u "%system.package-manager.deployer.username%:%system.package-manager.deployer.password%" "https://%system.package-manager.hostname%" --upload-file "${'$'}CHART_PACKAGE" | indent
            """.trimIndent()
            workingDir = "./softozor"
            dockerPull = true
